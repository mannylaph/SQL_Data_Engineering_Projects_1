# SQL Data Engineering Projects (PostgreSQL & DuckDB)

A collection of SQL projects built to demonstrate real-world data engineering skills — from data modeling to production-quality analytical querying.

> Click a project below to see the tools and queries behind it.
